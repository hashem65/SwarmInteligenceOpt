...
with open("Coords22.txt", "r") as ins:
...
with open("Coords23.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
...
nodelistx = [81,82,84,85,131,139]
nodelisty = [81,82,84,85,131,139]
...
with open("Lengths23.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
        arrayOfInputData.append(line)
