...
finalLocation [0,:] =  [ 9.71421979e-01 ,  0.00000000e+00 ,  0.00000000e+00]
finalLocation [1,:] =  [ 4.59242550e-17 ,  9.71422002e-01,   0.00000000e+00]
finalLocation [2,:] =  [ 8.71438585e-01  , 7.43616391e-02,   1.32579391e+00]
finalLocation [3,:] =  [ 7.43615888e-02 ,  8.71438656e-01,   1.32579388e+00]
finalLocation [4,:] =  [  6.25008612e-01 , -1.86673456e-01 ,  2.25089375e+00]
finalLocation [5,:] =  [ -1.86673524e-01  , 6.25008728e-01  , 2.25089382e+00]
finalLocation [6,:] =  [ 2.15201097e+00 ,  0.00000000e+00 ,  0.00000000e+00]
finalLocation [7,:] =  [ 1.22464680e-16  , 2.15201100e+00  , 0.00000000e+00]
finalLocation [8,:] =  [  2.27827815e+00,  -2.34325279e-01  , 1.55329590e+00]
finalLocation [9,:] =  [  -2.34325224e-01 ,  2.27827823e+00  , 1.55329589e+00]
finalLocation [10,:] =  [  1.59963206e+00 , -7.76981036e-01 ,  2.44212830e+00]
finalLocation [11,:] =  [ -7.76981333e-01  , 1.59963138e+00  , 2.44213045e+00]

finallengths = np.zeros((numberOfElements, 12))
finallengths[0,:] = [1.51227398 , 1.27783688 , 3.35017143 , 3.91152849 , 1.35312145 , 1.35312144 , 
                    1.58088085 , 1.58088084 , 1.18058899 , 1.180589  ,  1.55563103 , 1.555631  ]
finallengths[1,:] = [1.27783688 , 1.26359689 , 3.91152849 , 6.03838379 , 1.01916751 , 1.01916759 ,
                    1.90328112 , 1.90328319 , 1.55563103 , 1.555631 ,   1.20325594 , 1.20325554 ]
...
def findObjective(optmin,**kwargs):
    ...
    try:
        fibreRate1, sheetRate1, fibreRate2, sheetRate2, fibreRate3, sheetRate3  = optmin[0],optmin[1],optmin[2], optmin[3],optmin[4],optmin[5]
        fibreRate4, sheetRate4, fibreRate5, sheetRate5, fibreRate6, sheetRate6  = optmin[6],optmin[7],optmin[8], optmin[9],optmin[10],optmin[11]
        ...
        lengthIdx   = 0.0
        for i in range(12):
            lengthIdx += (finallengths[0,i] - geometricField.GeometricParametersElementLineLengthGet(1, i+1))**2 
            lengthIdx += (finallengths[1,i] - geometricField.GeometricParametersElementLineLengthGet(2, i+1))**2        
...
x0 = [0.0052, 0.0152, 0.0098, 0.029, 0.0152, 0.042, 0.0162, 0.0052, 0.032, 0.0122, 0.0452, 0.016]
...
bnds = [(2e-3,2e-2),(2e-3,5e-2),(2e-4,2e-2),(2e-3,5e-2),(2e-4,5e-2),(2e-3,5e-2),(2e-4,5e-2),(2e-3,5e-2),(2e-4,5e-2),(2e-3,5e-2),(2e-4,5e-2),(2e-3,5e-2),]
