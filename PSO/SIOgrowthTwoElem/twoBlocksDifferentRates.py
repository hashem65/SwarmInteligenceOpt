...
finalLocation [0,:] =  [  8.33024572e-01 ,  0.00000000e+00 ,  0.00000000e+00]
finalLocation [1,:] =  [  4.59242550e-17 ,  8.33024572e-01 ,  0.00000000e+00]
finalLocation [2,:] =  [  8.24111975e-01 , -2.14633222e-03 ,  1.20539694e+00]
finalLocation [3,:] =  [ -2.14633723e-03 ,  8.24111982e-01  , 1.20539694e+00]
finalLocation [4,:] =  [  8.53472632e-01 , -5.51901650e-02 ,  2.66948011e+00]
finalLocation [5,:] =  [ -5.51901672e-02 ,  8.53472628e-01 ,  2.66948010e+00]
finalLocation [6,:] =  [  2.06106018e+00 ,  0.00000000e+00 ,  0.00000000e+00]
finalLocation [7,:] =  [  1.22464680e-16 ,  2.06106018e+00 ,  0.00000000e+00]
finalLocation [8,:] =  [  2.13306935e+00 , -4.37983712e-02 ,  1.19957162e+00]
finalLocation [9,:] =  [ -4.37983723e-02 ,  2.13306935e+00 ,  1.19957162e+00]
finalLocation [10,:] =  [  2.11511546e+00,  -1.82544777e-01,  2.64772598e+00]
finalLocation [11,:] =  [ -1.82544794e-01,   2.11511543e+00,  2.64772596e+00]

finallengths = np.zeros((numberOfElements, 12))
finallengths[0,:] = [1.29682197,1.33366972,3.20858258,3.3888675,1.21246998,
                     1.21246997,1.20317996,1.20317996,1.22803561,1.22803561,
                     1.31417098,1.31417097]
finallengths[1,:] = [1.33366972,1.41457277,3.3888675,3.76745386,1.47011636,
                     1.47011636,1.47221857,1.47221854,1.31417098,1.31417097,
                     1.27709542,1.2770954 ]
...
x0 = [0.0062, 0.0252, 0.00022, 0.0182, 0.0452, 0.00022]
fkeys = ['fibreRate1','sheetRate1','normalRate1','fibreRate2','sheetRate2','normalRate2']
...
bnds = [(2e-4,2e-2),(5e-3,5e-2),(1e-5,1e-3),(2e-4,2e-2),(5e-3,5e-2),(1e-5,1e-3)]
...
if doGlobalSearch:
    ...
    augmentedLagrnagePSO = ALPSO(SwarmSize=5)
