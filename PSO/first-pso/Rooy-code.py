...
# defining a class for the Particle considering its position and velocity
class Particle:
    def __init__(self,x0):
        self.positionIndividual=[]          # particle's individual position
        self.velocityIndividual=[]          # particle individual velocity
        self.positionBestIndividual=[]      # best individual position for one particle
