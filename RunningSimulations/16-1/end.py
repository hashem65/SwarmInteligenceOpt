...
with open("Coords16.txt", "r") as ins:
...
with open("Coords17.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
...
nodelistx = [81,82,84,85,91,99,107,115,123,131,139]
nodelisty = [81,82,84,85,91,99,107,115,123,131,139]
...
with open("Lengths17.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
        arrayOfInputData.append(line)
