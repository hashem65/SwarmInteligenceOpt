...
with open("Coords1.txt", "r") as ins:
...
with open("Coords2.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
...
with open("Lengths2.txt", "r") as ins:
    arrayOfInputData = []
    for line in ins:
        arrayOfInputData.append(line)
...
def findObjective(optmin,**kwargs):
    ...
    timesteps = int(np.max([np.floor(optmin[0]/maxFibreGrowthRate),np.floor(optmin[1]/maxSheetGrowthRate),np.floor(optmin[2]/maxFibreGrowthRate),np.floor(optmin[3]/maxSheetGrowthRate),
							...
							np.floor(optmin[64]/maxFibreGrowthRate),np.floor(optmin[65]/maxSheetGrowthRate),np.floor(optmin[66]/maxFibreGrowthRate),np.floor(optmin[67]/maxSheetGrowthRate),
                            np.floor(optmin[68]/maxFibreGrowthRate),np.floor(optmin[69]/maxSheetGrowthRate),np.floor(optmin[70]/maxFibreGrowthRate),np.floor(optmin[71]/maxSheetGrowthRate),
							np.floor(optmin[72]/maxFibreGrowthRate),np.floor(optmin[73]/maxSheetGrowthRate),np.floor(optmin[74]/maxFibreGrowthRate),np.floor(optmin[75]/maxSheetGrowthRate),
                            np.floor(optmin[76]/maxFibreGrowthRate),np.floor(optmin[77]/maxSheetGrowthRate),np.floor(optmin[78]/maxFibreGrowthRate),np.floor(optmin[79]/maxSheetGrowthRate),
                            np.floor(optmin[80]/maxFibreGrowthRate),np.floor(optmin[81]/maxSheetGrowthRate),np.floor(optmin[82]/maxFibreGrowthRate),np.floor(optmin[83]/maxSheetGrowthRate),
							np.floor(optmin[84]/maxFibreGrowthRate),np.floor(optmin[85]/maxSheetGrowthRate),np.floor(optmin[86]/maxFibreGrowthRate),np.floor(optmin[87]/maxSheetGrowthRate),
                            np.floor(optmin[88]/maxFibreGrowthRate),np.floor(optmin[89]/maxSheetGrowthRate),np.floor(optmin[90]/maxFibreGrowthRate),np.floor(optmin[91]/maxSheetGrowthRate),
                            np.floor(optmin[92]/maxFibreGrowthRate),np.floor(optmin[93]/maxSheetGrowthRate),np.floor(optmin[94]/maxFibreGrowthRate),np.floor(optmin[95]/maxSheetGrowthRate),]))
    for i in range (numberOfElements/2):
        growthTensor[2*i,0] = optmin[3*i]/timesteps
        growthTensor[2*i,1] = optmin[3*i+1]/timesteps
        growthTensor[2*i,2] = optmin[3*i+2]/timesteps
...
4.38E-07	,		4.61E-07	,		0	,
0.082898109	,		0	,		0	,
0.000180835	,		1.49E-07	,		0	,
0.098998003	,		0.037621669	,		0	,
0.00E+00	,		9.81E-07	,		0	,
0.098999623	,		0	,		0	,
9.90E-02	,		0	,		0	,
0.099	,		0	,		0	,
...
fkeys = ['fibreRate1','sheetRate1','fibreRate2','sheetRate2','fibreRate3','sheetRate3','fibreRate4','sheetRate4','fibreRate5','sheetRate5','fibreRate6','sheetRate6',
        ...
        'fibreRate29','sheetRate29','fibreRate30','sheetRate30','fibreRate31','sheetRate31','fibreRate32','sheetRate32','fibreRate33','sheetRate33','fibreRate34','sheetRate34',
        'fibreRate35','sheetRate35','fibreRate36','sheetRate36','fibreRate37','sheetRate37','fibreRate38','sheetRate38','fibreRate39','sheetRate39','fibreRate40','sheetRate40',
        'fibreRate41','sheetRate41','fibreRate42','sheetRate42','fibreRate43','sheetRate43','fibreRate44','sheetRate44',
        'fibreRate45','sheetRate45','fibreRate46','sheetRate46','fibreRate47','sheetRate47','fibreRate48','sheetRate48']
