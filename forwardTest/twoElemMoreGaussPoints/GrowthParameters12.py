                    ...
                    for xiIdx3 in range(1,numberOfGaussXi+1):
                        for xiIdx2 in range(1,numberOfGaussXi+1):
                            for xiIdx1 in range(1,numberOfGaussXi+1):
                                ...
                                sheetRate1 = sheetRate
                                sheetRate2 = sheetRate*2
                                sheetRate3 = sheetRate*3
                                fibreRate1 = fibreRate
                                fibreRate2 = fibreRate*2
                                fibreRate3 = fibreRate*3
                                if xiIdx3 == 1: 
                    ...
                    for xiIdx3 in range(1,numberOfGaussXi+1):
                        for xiIdx2 in range(1,numberOfGaussXi+1):
                            for xiIdx1 in range(1,numberOfGaussXi+1):
                                ...
                                sheetRate =   0.005              # changing the growth rates based on the 
                                normalRate =   0.0001              # for the normal rate we can have non-zero    
                                sheetRate4 = sheetRate
                                sheetRate5 = sheetRate*2
                                sheetRate6 = sheetRate*3
                                fibreRate4 = fibreRate
                                fibreRate5 = fibreRate*2
                                fibreRate6 = fibreRate*3
                                if xiIdx3 == 1: 
                                    growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,
                                                                                           iron.FieldParameterSetTypes.VALUES,
                                                                                           gaussPointNumber,elementNumber,1,
